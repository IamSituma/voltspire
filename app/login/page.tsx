    ...
    <div className="container px-4 py-8 md:px-6 md:py-12 max-w-md mx-auto">
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <Button
            className="bg-yellow-500 text-black w-full hover:bg-black hover:text-white"
            type="submit"
          >
            Sign In
          </Button>
        ...
        <CardFooter className="flex flex-col">
          <p className="text-center text-sm text-muted-foreground">
            ...
            <Link href="/register" className="text-primary hover:underline text-yellow-700 font-bold">
              Sign up
            </Link>
          </p>
        </CardFooter>
